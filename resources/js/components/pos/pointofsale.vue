                ...
                <div class="card-footer">       <!-----Expense_Insert_Table(Middle_Left)------->
                    <ul class="list-group">
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            Total Quantity:
                            <strong>{{ Number(qty).toLocaleString() }}</strong>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            Sub Total:
                    ...
                    <form @submit.prevent="orderdone">          <!--------------2----------------->
                        ...
                        <select class="form-control" v-model="payby">
                            ...
                            <option value="Voucher Card">Voucher Card</option>
                            <option value="Gift Card">Gift Card</option>
                        </select>

                        <br>
                        <button type="submit" class="btn btn-primary mb-4 shadow">Submit</button>
                    </form>
                </div>
            </div>
        </div>
