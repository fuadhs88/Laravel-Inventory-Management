       ...
       <div class="shadow" style="margin-bottom:2rem">
         <div class="card">
          <div class="card-header text-primary" style="font-size: 20px; font-weight: 700;">
            ...
            Pay Salary
            <router-link to="/given-salary" class="btn btn-primary shadow" id="add_new"> All Employee Salary</router-link>
          </div>
          ...
          <div class="card-body">
	          ...
	          <div class="form-group">
               ...
               <button type="submit" class="btn btn-primary shadow">Pay Now</button>
              </form>
          </div>
         </div>
       </div>
